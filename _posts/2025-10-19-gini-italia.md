...
Useremo i dati dell'ultima mandata di scraping disponibile ad ora, che può essere leggermente diversa (per qualche giorno o mese) da città a città, ma non ci aspettiamo differenze sostanziali per la nostra analisi.
...
Palermo è la meno diseguale, Milano la peggiore. Tenendo conto del fatto che si tratta ovviamente di città diverse in termini di taglia e popolazione, e notando che le differenze non sono enormi, vale a dire che ogni città ha una certa disuguaglianza chiara, è comunque abbastanza interessante. 

Ci aspettiamo che ovunque esistano agenzie che o gestiscono Airbnb per conto di singoli proprietari e quindi li raggruppano assieme, o ne detengono la proprietà direttamente, quindi molto probabilmente gli ospiti maggiori non sono dei singoli; andiamo a vedere chi sono. Vale la pena notare che se di agenzie si tratta, non è detto che queste operino solo sul territorio della città in esame, potrebbero avere in inventario alloggi ovunque, e questa è una cosa che indagheremo dopo - i dati qui si riferiscono solo alle proprietà che un ospite ha nella città stessa-

> TODO e qui devo continuare secondo il piano